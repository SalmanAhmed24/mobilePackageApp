...
import { locationOffer } from '../utils/constants';
...
function LocationOffer({ navigationProps }) {
	const renderItem = ({ item }) => <Item itemObj={item} />;
	const navigationHandler = () => {
		navigationProps.navigation.push(`Location`, {
			name: 'Home'
		});
	};
	// functions
		...
		return (
			<View style={styles.container}>
				<View style={styles.mainHeadCon}>
					<Text style={styles.mainHead}>Location Based Offers</Text>
