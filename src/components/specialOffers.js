...
import { specialOffer } from '../utils/constants';
...
function SpecialOffer({ navigationProps }) {
	const renderItem = ({ item }) => <Item itemObj={item} />;

	// functions
	const navigationHandler = () => {
		navigationProps.navigation.push(`Hybrid`, {
			name: 'Home'
		});
	};
	// fonts
		...
		return (
			<View style={styles.container}>
				<View style={styles.mainHeadCon}>
					<Text style={styles.mainHead}>Special Offers</Text>
