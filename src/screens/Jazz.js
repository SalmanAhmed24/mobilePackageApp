		...
		return (
			<View style={styles.container}>
				<View style={styles.imageWrap}>
					<Image style={styles.image} source={require('../../assets/images/jazz.png')} />
				</View>
				<View style={styles.infoContainer}>
					<Text style={styles.mainHeading}>All Jazz Packages</Text>
